...
public enum ModArmorMaterials implements ArmorMaterial {
    FENTANYL("fentanyl", 29, new int[] {3, 8, 6, 3}, 23, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2f,0f, () -> Ingredient.ofItems(ModItems.FENTANYL));
    ...
    public String getName() {
        return Fentanyl.MOD_ID + ":" + this.name;
    }
